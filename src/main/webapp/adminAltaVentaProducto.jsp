...
<body>
	...
	<div class="row">
		...
		<h5 class="mt-2">Alta Venta de Producto</h5><a class="anchor"></a>
							<%
		//AltaCliente
		if(request.getParameter("resultado")!= null){
			...
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! la tarjeta seleccionada no existe</div>
				</div>
			</div>
			
			<% }
			else if(resultado.equalsIgnoreCase("errorProducto")){%>
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! el producto seleccionado no existe</div>
				</div>
			</div>
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_venta_de_producto" method="post">
								<fieldset>
									<br>
