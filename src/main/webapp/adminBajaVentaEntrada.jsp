...
<%
		...
		ArrayList<VentaEntradas> ventaentradas = controladorBD.todasVentasEntradas();		
		%>
	<div class="navbar">
		<div class="row">
	...
	<div class="row">
		...
		<h5 class="mt-2">Baja venta de entrada</h5><a class="anchor"></a>
					<%
		...
		if(request.getParameter("resultado")!= null){
			...
			if(resultado.equalsIgnoreCase("error")){%>	
				<div class="row grid-responsive">
					<div class="column">
						<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! La venta seleccionada no existe en la base de datos</div>
					</div>
				</div>
			<% }
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=baja_ventaEntrada" method="post">
								<fieldset>
									<br>
									<select id="id_ventaEntrada" name="id_ventaEntrada" is="ms-dropdown" required style="width:450px" data-child-height="415">
										<option value="">selecciona el ID de la venta de entrada</option>
											<%for(int i = 0;i<ventaentradas.size();i++) {%>
										<option value="<%=ventaentradas.get(i).getId_ventaEntrada()%>"><%=ventaentradas.get(i).getId_ventaEntrada()%> </option>
											<%}%>
									</select>
									<br>
