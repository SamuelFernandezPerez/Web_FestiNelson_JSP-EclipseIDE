...
<body>
	...
	<div class="row">
		...
		<h5 class="mt-2">Alta venta de entrada</h5><a class="anchor"></a>
							<%
		//AltaCliente
		if(request.getParameter("resultado")!= null){
			...
			<% }
			else if(resultado.equalsIgnoreCase("errorEntrada")){%>
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! La entrada seleccionada no existe</div>
				</div>
			</div>
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_venta_de_entrada" method="post">
								<fieldset>
									<br>
									...
									<select id="id_entrada" name="id_entrada" is="ms-dropdown" required style="width:450px" data-child-height="415">
										<option value="">selecciona el ID de la entrada</option>
