...
<html class="wide wow-animation" lang="en">
  ...
  <%
	...
	ArrayList<VentaEntradas> ventasEntradas = new ArrayList<VentaEntradas>();
	ventasProductos = bdController.dameVentasProductosPorIdCliente(Integer.parseInt(id_cliente));
	ventasEntradas = bdController.dameVentasEntradasPorIdCliente(Integer.parseInt(id_cliente));
	...
	//productos = bdController.dameProductosPorIdCliente(Integer.parseInt(id_cliente));
	//entradas = bdController.dameEntradasPorIDcliente(Integer.parseInt(id_cliente));
    ...
    background-color: #4ac4cf !important;
        display: inline-block !important;
    "><h1>Productos comprados por <%=cliente.getNombre() %></h1></div> 
    <%for (int i = 0; i < ventasProductos.size(); i++) {
    	Producto producto = bdController.dameproducto(ventasProductos.get(i).getId_producto());
    	Tarjeta tarjeta = bdController.dameTarjeta(ventasProductos.get(i).getId_tarjeta());
    %>
		<section class="section section-lg bg-default" style="margin-top: 1rem">
        <div class="container">
          <div class="row row-50 flex-md-row-reverse">
            <div class="col-md-6 text-center">
              <div class="box-image-1" style="margin-top: 10rem;"><img src="images/productos/<%=ventasProductos.get(i).getId_producto() %>.PNG" alt="" width="468" height="276" title='<%=producto.getNombre() %>'/>
              </div>
            </div>
            <div class="col-md-6">
              <div class="box-about">
                <h5 class="box-about-post-title" style="color: white !important;">ID producto: <%=ventasProductos.get(i).getId_producto() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Nombre: <%=producto.getNombre() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Precio: <%=producto.getPrecio() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">ID venta: <%=ventasProductos.get(i).getId_venta() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">ID tarjeta: <%=ventasProductos.get(i).getId_tarjeta() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Saldo tarjeta: <%=tarjeta.getSaldo() %></h5>
              </div>
            </div>
          </div>
          <hr>
    ...
    background-color: #4ac4cf !important;
        display: inline-block !important;
    "><h1>Entradas compradas por <%=cliente.getNombre() %></h1></div>
	<%for (int i = 0; i < ventasEntradas.size(); i++) {
     Tarjeta tarjeta2 = bdController.dameTarjeta(ventasEntradas.get(i).getId_tarjeta());
     TipoEntrada tipoEntrada = bdController.dameTipoEntradaPorIDentrada(ventasEntradas.get(i).getId_entrada());
    %>
		<section class="section section-lg bg-default" style="margin-top: 1rem">
        <div class="container">
          <div class="row row-50 flex-md-row-reverse">
            <div class="col-md-6 text-center">
              <div class="box-image-1" style="margin-top: 10rem;"><img src="images/entrada/entrada.PNG" alt="" width="468" height="276" title='<%=tipoEntrada.getDescripcion() %>'/>
              </div>
            </div>
            <div class="col-md-6">
              <div class="box-about">
                <h5 class="box-about-post-title" style="color: white !important;">ID entrada: <%=ventasEntradas.get(i).getId_entrada() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">ID tipo de entrada: <%=tipoEntrada.getId_tipoEntrada() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Descripción: <%=tipoEntrada.getDescripcion() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Precio: <%=tipoEntrada.getPrecio() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">ID venta: <%=ventasEntradas.get(i).getId_ventaEntrada() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">ID tarjeta: <%=ventasEntradas.get(i).getId_tarjeta() %></h5>
                <h5 class="box-about-post-title" style="color: white !important;">Saldo tarjeta: <%=tarjeta2.getSaldo() %></h5>
              </div>
            </div>
          </div>
          <hr>
