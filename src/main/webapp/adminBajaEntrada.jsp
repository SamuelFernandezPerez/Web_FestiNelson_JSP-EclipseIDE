...
<%
	...
	<div class="row">
		...
		<h5 class="mt-2">Baja entrada</h5><a class="anchor"></a>
					<%
		...
		if(request.getParameter("resultado")!= null){
			...
			if(resultado.equalsIgnoreCase("error")){%>	
				<div class="row grid-responsive">
					<div class="column">
						<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! La Entrada seleccionada no existe en la base de datos</div>
					</div>
				</div>
			<% }
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=baja_entrada" method="post">
								<fieldset>
									<br>
