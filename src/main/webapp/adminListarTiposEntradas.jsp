...
<body>
	...
	<div class="row">
		...
		<section id="main-content" class="column column-offset-20">
			<h5 class="mt-2">Todos los tipos de entradas</h5><a class="anchor" name="tables"></a>
					...
					<div class="card">
						...
						<div class="container" style="text-align: center;">
							...
							<table class="myTable table hover">
								...
								<tbody>
									<tr>
										<td><%=tipoEntradas.get(i).getId_tipoEntrada() %></td>
										<td><%=tipoEntradas.get(i).getDescripcion() %></td>
										<td><%=tipoEntradas.get(i).getPrecio() %></td>	
										<td><%=tipoEntradas.get(i).getCantidad() %></td>	
									</tr>
								</tbody>
								<%} %>
							</table>
