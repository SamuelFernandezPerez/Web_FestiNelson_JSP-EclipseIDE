...
<body>
	...
	<div class="row">
		...
		<h5 class="mt-2">Alta Tarjeta</h5><a class="anchor"></a>
							<%
		//AltaCliente
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_tarjeta" method="post">
								<fieldset>
									<br>
									<input type="text" name="saldo" id="saldo" placeholder="Introduzca saldo. (max 999.99)" maxlength="6">
									<br>
