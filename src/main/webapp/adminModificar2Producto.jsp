...
<%
		...
		Producto producto = controladorBD.dameproducto(id_producto);
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=modificar_producto&id_producto=<%=id_producto %>" method="post">
								<fieldset>
									<div class="">
										<img src = "images/productos/<%=producto.getId_producto() %>.PNG" width='140' height='100'>
									</div>
									<br>
									<label for="nombre">Nombre</label>
									<input type="text" name="nombre" id="nombre" value="<%=producto.getNombre() %>" maxlength="30">
									<label for="precio">Precio</label>
									<input type="text" name="precio" id="precio" value="<%=producto.getPrecio() %>" maxlength="6">
									<br>
