...
<body>
  <%
	...
	entradas = bdController.todasEntradas();
	%>
	<div class="navbar">
		<div class="row">
	...
	<div class="row">
		...
		<section id="main-content" class="column column-offset-20">
			<h5 class="mt-2">todas las entradas</h5><a class="anchor" name="tables"></a>
						...
						<div class="card-block">
							...
							<table class="myTable table hover">
								<thead>
									<tr>
										<th>ID entrada</th>
										<th>ID tipo de entrada</th>
										<th>Descripción tipo de entrada</th>
									</tr>
								</thead>
								 <%for (int i = 0; i < entradas.size(); i++) {
								 TipoEntrada tipoEntrada = bdController.dameTipoEntradaPorIDentrada(entradas.get(i).getId_entrada());%>
								<tbody>
									<tr>
										<td><%=entradas.get(i).getId_entrada() %></td>
										<td><%=entradas.get(i).getId_tipoEntrada() %></td>
										<td><%=tipoEntrada.getDescripcion() %></td>
									</tr>
								</tbody>
								<%} %>
							</table>
