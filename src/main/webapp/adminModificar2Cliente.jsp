...
<%
		...
		Cliente cliente = controladorBD.dameCliente(id_cliente);
	...
	<div class="row">
		...
		<h5 class="mt-2">Modificar cliente</h5><a class="anchor"></a>
					<%
		if(request.getParameter("resultado")!= null){
			...
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! El tipo de entrada elegido no existe</div>
				</div>
			</div>
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=modificar_cliente&id_cliente=<%=id_cliente %>" method="post">
								<fieldset>
									<div class="">
										<img src = "images/clientes/<%=cliente.getId_cliente() %>.jpg" width='140' height='100'>
									</div>
									<br>
									<label for="nombre">Nombre</label>
									<input type="text" name="nombre" id="nombre" value="<%=cliente.getNombre() %>"  maxlength="15">
									<label for="apellidos">Apellidos</label>
									<input type="text" name="apellidos" id="apellidos" value="<%=cliente.getApellidos() %>" maxlength="30">
									<label for="dni">DNI</label>
									<input type="text" name="dni" id="dni" value="<%=cliente.getDni() %>" maxlength="9">
									<label for="direccion">Dirección</label>
									<input type="text" name="direccion" id="direccion" value="<%=cliente.getDireccion() %>" maxlength="30">
									<label for="cp">Código postal</label>
									<input type="number" name="cp" id="cp" value="<%=cliente.getCp() %>" maxlength="5">
									<label for="provincia">Provincia</label>
									<input type="text" name="provincia" id="provincia" value="<%=cliente.getProvincia() %>" maxlength="30">
									<label for="fechaNac">Fecha de nacimineto</label>
									<input type="text" name="fechaNac" id="fechaNac" value="<%=cliente.getFecha_nacimiento() %>"maxlength="10">
									<br>
