...
<body>
<%
int id_tipoEntrada = Integer.parseInt(request.getParameter("id_tipoEntrada"));
BDController controladorBD = new BDController();
TipoEntrada tipoEntrada = controladorBD.dameTipoEntrada(id_tipoEntrada);
%>
	<div class="navbar">
		<div class="row">
	...
	<div class="row">
		...
		<h5 class="mt-2">Modificar tipo de entrada</h5><a class="anchor"></a>
					<%
		//AltaCliente
		if(request.getParameter("resultado")!= null){
			...
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! ya existe un tipo de entrada creado con esa descripcion</div>
				</div>
			</div>
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=modificar_tipoEntrada&id_tipoEntrada=<%=id_tipoEntrada %>" method="post">
								<fieldset>
									<br>
									<label for="descripcion">Descripcion</label>
									<input type="text" name="descripcion" id="descripcion" value="<%=tipoEntrada.getDescripcion() %>" maxlength="100">
									<label for="precio">Precio</label>
									<input type="text" name="precio" id="precio" value="<%=tipoEntrada.getPrecio() %>" maxlength="6">
									<label for="cantidad">Cantidad</label>
									<input type="text" name="cantidad" id="cantidad" value="<%=tipoEntrada.getCantidad() %>" maxlength="6">
									<br>
