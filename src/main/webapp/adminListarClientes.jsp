...
<body>
	...
	<div class="row">
		...
		<section id="main-content" class="column column-offset-20">
			<h5 class="mt-2">Todos los clientes</h5><a class="anchor" name="tables"></a>
					...
					<div class="card">
						...
						<div class="container" style="text-align: center;">
							...
							<table class="myTable table hover">
								...
								<tbody>
									<tr>
										<td><img src="images/clientes/<%=clientes.get(i).getId_cliente() %>.jpg" alt="profile photo" class="circle float-left profile-photo" width="600" height="auto" title='<%= clientes.get(i).getNombre()%>'></td>	
										<td><%=clientes.get(i).getId_cliente() %></td>
										<td><%=clientes.get(i).getDni() %></td>
										<td><%=clientes.get(i).getNombre() %></td>
										<td><%=clientes.get(i).getApellidos() %></td>
										<td><%=clientes.get(i).getDireccion() %></td>
										<td><%=clientes.get(i).getCp() %></td>
										<td><%=clientes.get(i).getProvincia() %></td>
										<td><%=clientes.get(i).getFecha_nacimiento() %></td>
									</tr>
								</tbody>
								<%} %>
							</table>
