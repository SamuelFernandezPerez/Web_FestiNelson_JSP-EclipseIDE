...
<%
	...
	<div class="row">
		...
		<h5 class="mt-2">Modificación cliente</h5><a class="anchor"></a>
					<%
		//AltaCliente
		if(request.getParameter("resultado")!= null){
			...
			<% }
				...
				<div class="row grid-responsive">
					<div class="column">
						<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! El cliente seleccionado no existe en la base de datos</div>
					</div>
				</div>
			<% }
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="adminModificar2Cliente.jsp" method="post">
								<fieldset>
									<br>
