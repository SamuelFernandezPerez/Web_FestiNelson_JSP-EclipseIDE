...
<body>
	...
	ventaEntradas = bdController.todasVentasEntradas();
	%>
	<div class="navbar">
		<div class="row">
	...
	<div class="row">
		...
		<section id="main-content" class="column column-offset-20">
			<h5 class="mt-2">todas las ventas de entradas</h5><a class="anchor" name="tables"></a>
					...
					<div class="card">
						...
						<div class="container" style="text-align: center;">
							...
							<table class="myTable table hover">
								...
								<tbody>
									<tr>
										<td><%=ventaEntradas.get(i).getId_ventaEntrada() %></td>
										<td><%=ventaEntradas.get(i).getId_tarjeta() %></td>
										<td><%=ventaEntradas.get(i).getId_entrada() %></td>
									</tr>
								</tbody>
								<%} %>
							</table>
