...
<%
		...
		ArrayList<VentaProductos> ventaproductos = controladorBD.todasVentasProductos();		
		%>
	<div class="navbar">
		<div class="row">
	...
	<div class="row">
		...
		<h5 class="mt-2">Baja venta de producto</h5><a class="anchor"></a>
					<%
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=baja_ventaProducto" method="post">
								<fieldset>
									<br>
									<select id="id_ventaproducto" name="id_ventaproducto" is="ms-dropdown" required style="width:450px" data-child-height="415">
										<option value="">selecciona el ID de la venta del producto</option>
											<%for(int i = 0;i<ventaproductos.size();i++) {%>
										<option value="<%=ventaproductos.get(i).getId_venta()%>"><%=ventaproductos.get(i).getId_venta()%> </option>
											<%}%>
									</select>
									<br>
