...
<body>
	...
	<%
		...
		String tipoEntrada = controladorBD.dameDescripcionTipoEntradaPorIDentrada(id_entrada);	
		%>
		<div class="row">
	...
	<div class="row">
		...
		<h5 class="mt-2">Modificar Entrada</h5><a class="anchor"></a>
							<%
		if(request.getParameter("resultado")!= null){
			...
			<div class="row grid-responsive">
				<div class="column">
					<div class="alert background-danger"><em class="fa fa-times-circle"></em> ¡ERROR! El dni ya esta asociado a un cliente</div>
				</div>
			</div>
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=modificar_entrada&id_entrada=<%=id_entrada %>" method="post">
								<fieldset>
									<br>
									<select id="id_tipoEntrada" name="id_tipoEntrada" is="ms-dropdown" required style="width:450px" data-child-height="415">
										<option value=""><%=tipoEntrada %></option>
