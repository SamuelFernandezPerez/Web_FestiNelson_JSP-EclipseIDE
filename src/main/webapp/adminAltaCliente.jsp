...
<body>
	...
	<div class="row">
		...
		<h5 class="mt-2">Alta cliente</h5><a class="anchor"></a>
					<%
		//AltaCliente
						...
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_cliente" method="post">
								<fieldset>
									...
									<input type="text" name="nombre" id="nombre" placeholder="Introduzca nombre" maxlength="15">
									<label for="apellidos">Apellidos</label>
									<input type="text" name="apellidos" id="apellidos" placeholder="Introduzca apellidos" maxlength="30">
									<label for="dni">DNI</label>
									<input type="text" name="dni" id="dni" placeholder="Introduzca DNI" maxlength="9">
									<label for="direccion">Dirección</label>
									<input type="text" name="direccion" id="direccion" placeholder="Introduzca direccion" maxlength="30">
									<label for="cp">Código postal</label>
									<input type="tel" name="cp" id="cp" placeholder="Introduzca código postal" maxlength="5">
									<label for="provincia">Provincia</label>
									<input type="text" name="provincia" id="provincia" placeholder="Introduzca provincia" maxlength="30">
									<label for="fechaNac">Fecha de nacimineto</label>
									<input type="date" name="fechaNac" id="fechaNac" placeholder="Introduzca fecha de nacimineto" maxlength="10">
									<br>
