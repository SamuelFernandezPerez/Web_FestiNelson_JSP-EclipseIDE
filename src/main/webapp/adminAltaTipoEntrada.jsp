...
<body>
	...
	<div class="row">
		...
		<h5 class="mt-2">Alta tipo de entrada</h5><a class="anchor"></a>
					<%
		//AltaCliente
				...
				<div class="column ">
					<div class="card">
						<div class="card-block">
							<form action="operaciones.jsp?tipo=alta_tipo_de_entrada" method="post">
								<fieldset>
									<br>
									<label for="descripcion">Descripcion</label>
									<input type="text" name="descripcion" id="descripcion" placeholder="Introduzca descripcion" maxlength="100">
									<label for="precio">Precio</label>
									<input type="text" name="precio" id="precio" placeholder="Introduzca precio. (max 999.99)" maxlength="6">
									<label for="cantidad">Cantidad</label>
									<input type="text" name="cantidad" id="cantidad" placeholder="Introduzca cantidad" maxlength="6">
									<br>
