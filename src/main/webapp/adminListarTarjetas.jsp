...
<body>
	...
	<div class="row">
		...
		<section id="main-content" class="column column-offset-20">
			<h5 class="mt-2">todas las tarjetas</h5><a class="anchor" name="tables"></a>
					...
					<div class="card">
						<div class="card-block">
							...
							<table class="myTable table hover">
								...
								<tbody>
									<tr>
										<td><%=tarjetas.get(i).getId_tarjeta() %></td>
										<td><%=tarjetas.get(i).getSaldo() %></td>
										<td><%=tarjetas.get(i).getId_cliente() %></td>
										<td><img src="images/clientes/<%=tarjetas.get(i).getId_cliente() %>.jpg" alt="profile photo" class="circle float-left profile-photo" width="130" height="auto" title='<%= cliente.getNombre()%>'></td>	
									</tr>
								</tbody>
								<%} %>
							</table>
